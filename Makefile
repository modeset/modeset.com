...
app:
	...
	# cat $(JS_APP_DIR)/services/json_service.js >> $(JS_OUTPUT_DIR)/app.js
	# cat $(JS_APP_DIR)/model.js >> $(JS_OUTPUT_DIR)/app.js
	cat $(JS_APP_DIR)/views/header_view.js >> $(JS_OUTPUT_DIR)/app.js
